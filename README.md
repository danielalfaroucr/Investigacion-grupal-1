...
Este repositorio se enfoca en las bases de datos NoSQL, específicamente en las bases de datos orientadas a documentos. Además de evaluar las características que hacen a este tipo de base de datos convenientes y útiles, se comparan dos software diseñados para su manejo: CouchDB y OrientDB. Antes de entrar en detalles, es importante entender estos conceptos:
...
[Propuesta NOSQL](link_to_document)
